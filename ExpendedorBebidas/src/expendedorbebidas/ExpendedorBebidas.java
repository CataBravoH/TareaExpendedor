...
public class ExpendedorBebidas {
    ...
    public static void main(String[] args) {
        ...
        Expendedor expen = new Expendedor(6,400);
        ...
        Comprador Petunia = new Comprador(mon1000, Expendedor.COCA, expen);
        ...
        Comprador Rosa = new Comprador(mon500, Expendedor.FANTA, expen);
        ...
        Comprador Jazmin = new Comprador(mon100, Expendedor.COCA, expen);
